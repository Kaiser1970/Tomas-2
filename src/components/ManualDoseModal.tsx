      ...
      <div className="bg-cream-100 border border-cream-200 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-cream-200 bg-cream-100/90">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-coffee-900">Registrar Toma Extra / Manual</h3>
              <p className="text-xs text-coffee-500">Paciente: <span className="text-coffee-700 font-semibold">{patientName}</span></p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="p-3 rounded-xl bg-blue-100 border border-blue-500/20 text-xs text-blue-800 flex items-start gap-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-coffee-600 mb-1.5 flex items-center gap-1">
                <Clock className="w-3.5 h-3.5 text-coffee-500" />
                Hora de la toma
              </label>
              <input
                type="time"
                ...
                className="w-full px-3 py-2 rounded-xl bg-cream-200 border border-coffee-200 text-coffee-900 text-sm focus:outline-none focus:border-terracotta-500"
                required
              />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 pt-1">
            <input
              ...
              className="w-4 h-4 rounded text-terracotta-500 focus:ring-terracotta-500 bg-cream-200 border-coffee-200"
            />
            <label htmlFor="descontarStockManual" className="text-xs text-coffee-600">
